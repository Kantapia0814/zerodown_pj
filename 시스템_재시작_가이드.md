...
```bash
# 기본 설정 파일 확인
sudo nano /etc/nginx/conf.d/hello-service.conf
...
# 예상 결과:
# Active: Lionel Messi is the best player in the world!
# Standby: Zinedine Zidane is the best player in the world!
```
